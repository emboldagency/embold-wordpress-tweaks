...
# This script checks (by default) or updates (with --fix) version numbers in embold-wordpress-tweaks.php and readme.txt
# to match the latest local Git tag.

set -e

PLUGIN_MAIN_FILE="embold-wordpress-tweaks.php"
